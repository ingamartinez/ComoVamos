...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.gestion_usuarios.index', compact('users','roles','sucursales'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $user->syncRoles($request->check_rol);
...
//            throw new \Exception('No se pudo crear el usuario');
    ...
    {
        try{
            $user = User::withTrashed()->with('roles','circuitos')->findOrFail($id);
