 ...
 * Generated for Laravel 5.6.3 on 2018-05-05 11:18:40.
 *
...
namespace Caffeinated\Flash\Facades { 
    ...
    class Flash {
        ...
        {
            return \Caffeinated\Flash\FlashHandler::info($message);
        }
        ...
        {
            return \Caffeinated\Flash\FlashHandler::success($message);
        }
        ...
        {
            return \Caffeinated\Flash\FlashHandler::warning($message);
        }
        ...
        {
            return \Caffeinated\Flash\FlashHandler::error($message);
        }
        ...
        {
            return \Caffeinated\Flash\FlashHandler::message($message, $level);
        }
...
namespace  { 
    ...
    class Flash extends \Caffeinated\Flash\Facades\Flash {}
