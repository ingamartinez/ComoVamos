...
<head>
    ...
    <!-- App title -->
    <title>Login - Como Vamos Amcom SA</title>
...
<div class="wrapper-page">
    <div class="text-center">
        <a href="index.html" class="logo"><span>Como Vamos <span>Amcom S.A.</span></span></a>
        ...
        <div class="panel-body">
            <form class="form-horizontal m-t-20" action="{{route('login.store')}}" method="POST" autocomplete="off" id="form_login">
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control" type="text" name="cedula" id="cedula" required="" placeholder="Cedula">
                    </div>
                </div>
